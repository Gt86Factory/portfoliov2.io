...
<head>
	...
	<link href="style3bis.css" rel="stylesheet">
</head>
<body>
  ...
  <g id="white">
	...
	<div class="line-1 anim-typewriter">
		...
		<div class="line-1 anim-typewriter2">
			<p id=me>Hi I'm Anthony Novice Web Developper</p>	
		</div>	
			<div class="line-1 anim-typewriter3">
				<p>Sophie gonna show you everything you need to</p>	
			</div>
				<div class="line-1 anim-typewriter4">
					<p>know about me</p>	
				</div>	
	<div class="component">
        <ul class="align">
          <li  style="left:23%">
            <figure class='book'>
              ...
              <ul class='page'>
                <li></li>
                <li>
                  <a class="btn" href="experiencebis.php">Click Here</a>
                </li>
                <li></li>
                <li></li>
                <li></li>
          ...
          <li   style="left:40%">
            <figure class='book'>
              ...
              <ul class='page'>
                <li></li>
                <li>
                  <a class="btn1" href="projectbis.php">Click Here</a>
                </li>
                <li></li>
                <li></li>
                <li></li>
          ...
          <li   style="left:57%">
            <figure class='book'>
              ...
              <ul class='page'>
                <li></li>
                <li>
                  <a class="btn2" href="contactbis.php">Click Here</a>
                </li>
                <li></li>
                <li></li>
                <li></li>
